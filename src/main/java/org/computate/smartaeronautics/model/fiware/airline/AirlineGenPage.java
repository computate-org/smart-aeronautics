...
public class AirlineGenPage extends AirlineGenPageGen<PageLayout> {
  ...
  protected void _location(Wrap<JsonObject> w) {
    Point point = Airline.staticSetLocation(siteRequest_, Optional.ofNullable(siteRequest_.getRequestVars().get(VAR_location)).orElse(siteRequest_.getConfig().getString(ConfigKeys.DEFAULT_MAP_LOCATION)));
